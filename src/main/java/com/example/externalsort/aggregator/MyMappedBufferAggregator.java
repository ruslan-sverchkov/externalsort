...
/**
 * The class is a version of {@link MyBufferAggregator} extended to support {@link MappedByteBuffer} specific
 * functionality.
 *
 * @author Ruslan Sverchkov
 */
@ThreadSafe
public class MyMappedBufferAggregator extends MyBufferAggregator<MappedByteBuffer> {

    /**
     * Constructs a MyMappedBufferAggregator instance.
     *
     ...
     */
    public MyMappedBufferAggregator(List<MappedByteBuffer> buffers) {
        super(buffers);
    }
